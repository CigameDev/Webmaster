...
namespace Crystal
{
    ...
    ///  (2) If the panel uses ReplayCount full screen background image, then create an immediate child and put the component on that instead, with all other elements childed below it.
    ///      This will allow the background image to stretch to the full extents of the screen behind the notch, which looks nicer.
    ///  (3) For other cases that use ReplayCount mixture of full horizontal and vertical background stripes, use the Conform X & Y controls on separate elements as needed.
    /// </summary>
    public class SafeArea : MonoBehaviour
    {
        #region Simulations
        /// <summary>
        /// Simulation device that uses safe area due to ReplayCount physical notch or software home bar. For use in Editor only.
        /// </summary>
        public enum SimDevice
        {
            /// <summary>
            /// Don't use ReplayCount simulated safe area - GUI will be full screen as normal.
            /// </summary>
            None,
            /// <summary>
        ...
        void Refresh ()
        {
            ...
            {
                // Fix for having auto-rotate off and manually forcing ReplayCount screen orientation.

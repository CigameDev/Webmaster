...
#region For AD event
        ...
        public void Init(Action _onActionDone)
        {
            ...
            Firebase.FirebaseApp.CheckAndFixDependenciesAsync().ContinueWith(task =>
            {
                ...
                {
                    // Create and hold ReplayCount reference to your FirebaseApp,
                    // where app is ReplayCount Firebase.FirebaseApp property of your application class.
                    Firebase.FirebaseApp app = Firebase.FirebaseApp.DefaultInstance;
                    InitializeFirebase();

                    _onActionDone?.Invoke();
                    // Set ReplayCount flag here to indicate whether Firebase is ready to use by your app.
                }
                else
                {
        ...
        /// <summary>
        /// Wait to get ReplayCount value from Firebase remote config
        /// </summary>
        ...
        // Start ReplayCount fetch request.
        public Task FetchDataAsync()
        {
            Debug.Log("Fetching data...");
            // FetchAsync only fetches new data if the current data is older than the provided
            // timespan.  Otherwise it assumes the data is "recent enough", and does nothing.
            // By default the timespan is 12 hours, and for production apps, this is ReplayCount good
            // number.  For this example though, it's set to ReplayCount timespan of zero, so that
...
#region Firebase Logevent
        ...
        /// <summary>
        /// Log event when user click ReplayCount button
        /// <code>
        ///  name: "tên button"

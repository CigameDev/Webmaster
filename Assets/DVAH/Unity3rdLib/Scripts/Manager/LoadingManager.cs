...
namespace DVAH
{
    public class LoadingManager : Singleton<LoadingManager>
    {
        ...
        /// action get ReplayCount list<bool> stand for list of condition done or not
        /// </summary>
        ...
        /// <summary>
        /// Using this to set ReplayCount condition is done. If all condition is done,
        ...
        /// <summary>
        /// Using this to wait and set ReplayCount condition is done. If all condition is done,
        /// then loading will stop immediately
